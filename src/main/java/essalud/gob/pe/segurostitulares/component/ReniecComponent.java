...
import essalud.gob.pe.segurostitulares.modelview.response.EstadoFallecidoResponse;
...
@Component
@AllArgsConstructor
public class ReniecComponent {
    private final NamedParameterJdbcTemplate jdbcTemplate;

    public Object getDataReniec(String SP, String PKG, SqlParameter[] typeParameters, Map<String, Object> params, String outParam1, String outParam2, Object outParam3) throws SQLException {
    ...
    public Object getEstadoFallecido(String SP, String PKG, SqlParameter[] typeParameters, Map<String, Object> params, String outParam1, String outParam2, String outParam3) throws SQLException {
        SimpleJdbcCall jdbcCall = null;
        ...
        try {
            ...
            log.info("get"+ out.get(outParam2));
            log.info("get"+ out.get(outParam3));
            EstadoFallecidoResponse dataResponse =new EstadoFallecidoResponse();
            dataResponse.setFlagResultado((String) out.get(outParam1));
            dataResponse.setMensaje((String) out.get(outParam2));
            dataResponse.setFechaFallecimiento((String)out.get(outParam3));
            return dataResponse;
